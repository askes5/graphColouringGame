...
%        \node [style=normal, label=left:$x_1$] (1) at (-3, 2.25) {};
%        \node [style=normal, label=left:$x_2$] (2) at (-3, 0.75) {};
%        \node [style=normal, label=left:$x_3$] (3) at (-3, -0.5) {};
%        \node [style=normal, label=left:$x_4$] (4) at (-3, -2) {};
%        \node [style=normal, label=right:$y_1$] (5) at (3, 2.25) {};
%        \node [style=normal, label=right:$y_2$] (6) at (3, 0.75) {};
%        \node [style=normal, label=right:$y_3$] (7) at (3, -0.5) {};
%        \node [style=normal, label=right:$y_4$] (8) at (3, -2) {};
%        \node [] (9) at (3, 3.5) {Out--neighbours};
%        \node [] (10) at (-3, 3.5) {In--neighbours};
%        \draw (1) to (0);
%        \draw (2) to (0);
%        \draw (0) to (3);
%        \draw (4) to (0);
...
%        \draw (0) to (7);
%        \draw (8) to (0);
%        \draw [dashed, red] (-1,0) ellipse (3cm and 5cm);
%        \end{tikzpicture}
%    \end{figure}
