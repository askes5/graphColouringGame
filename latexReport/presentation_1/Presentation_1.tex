...
\begin{frame}
    ...
    \begin{figure}
        ...
        \node [normal] (v4) at (-3.5,0.5) {a};
        \node [normal] (v9) at (-4.5,3) {b};
        \node [normal] (v2) at (-5.5,-0.5) {c};
        \node [normal] (v3) at (-6.5,1) {d};
        \node [normal, alt=<2>{fill=red}{fill=white}] (v6) at (-2,-1) {e};
        \node [normal] (v12) at (-0.5,2.5) {f};
        \node [normal] (v5) at (-3.5,-0.5) {g};
        \node [normal, alt=<2>{fill=red}{fill=white}] (v1) at (-7,0) {h};
        \node [normal] (v7) at (0.5,-1.5) {i};
        \node [normal] (v11) at (-2.5,4) {j};
        \node [normal] (v8) at (-1.5,1.5) {k};
        \node [normal, alt=<2>{fill=red}{fill=white}] (v10) at (-3,2.5) {l};
        ...
        \end{tikzpicture}
        \caption{The relation between guests}
    \end{figure}
    \uncover<2->{
    A dominating set is $\{e,l,h\}$
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \node [normal] (v9) at (-4.5,3) {b};
        \node [normal] (v2) at (-5.5,-0.5) {c};
        \node [normal, alt=<5>{draw=red}{draw=black}] (v3) at (-6.5,1) {d};
        \node [normal, alt=<2->{fill=red}{fill=white}] (v6) at (-2,-1) {e};
        \node [normal] (v12) at (-0.5,2.5) {f};
        \node [normal, alt=<3->{fill=blue}{fill=white}] (v5) at (-3.5,-0.5) {g};
        \node [normal, alt=<5>{draw=red}{draw=black}] (v1) at (-7,0) {h};
        \node [normal] (v7) at (0.5,-1.5) {i};
        \node [normal] (v11) at (-2.5,4) {j};
        \node [normal] (v8) at (-1.5,1.5) {k};
        \node [normal, alt=<4->{fill=red}{fill=white}] (v10) at (-3,2.5) {l};
        \draw [thick] (v1) edge (v2);
        \draw [thick] (v3) edge (v2);
        \draw [thick] (v1) edge (v3);
        \draw [thick] (v4) edge (v5);
        ...
        \draw [thick] (v10) edge (v8);
        \end{tikzpicture}
        \caption{The relationship between guests}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \node [normal, alt=<5->{fill=blue}{fill=white}] (v4) at (-3.5,0.5) {a};
        \node [normal] (v9) at (-4.5,3) {b};
        \node [normal] (v2) at (-5.5,-0.5) {c};
        \node [normal] (v3) at (-6.5,1) {d};
        \node [normal, alt=<2->{fill=red}{fill=white}] (v6) at (-2,-1) {e};
...
\begin{frame}
    ...
    \begin{block}{Defination}        
      For a graph $G$ the game domination number of $G$, is the minimum number of turns needed for Alice to ensure there is a dominating set.
    \end{block}
