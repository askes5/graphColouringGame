...
\begin{proof}
    ...
    There exits some $X_i,X_j$ such that $a\in X_i$ and $b\in x_j$. As $(a,b)$ is an edge by the definition of path decomposition $b\in X_i$ xor $a\in x_j$. If $a \in X_j$ then $a < v$, this is a contribution. Thus $b\in X_i$. As $v\in X_i$ $b$ is incident ot $v$ that is $b\in N^+(v)$. Hence $|Y|\leq|N^+(v)\leq k$.  
