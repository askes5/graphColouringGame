...
%    \node [normal, label=right:$v_{n-1}$] (v2) at (0,4) {};
%    \node [normal, label=right:$v_{2}$] (v5) at (0,6) {};
%    \node [normal, label=right:$v_{1}$] (v6) at (0,7) {}; 
%    \node (v3) at (-4,0) {};
%    \node (v4) at (4,0) {};    
%    
%    \node [] at (3.5,-1) {$K_w$};
%    \node[normal, label=below:$u_{1}$] (v7) at (-2.5,0) {};
%    \node[normal, label=below:$u_{2}$] (v8) at (-1.5,0) {};
%    \node[normal, label=below:$u_{w-1}$] (v9) at (1.5,0) {};
%    \node[normal, label=below:$u_{w}$] (v10) at (2.5,0) {};
%    \draw  (v7) edge (v1);
%    \draw  (v1) edge (v8);
%    \draw  (v1) edge (v9);
%    \draw  (v1) edge (v10);
...
%    \draw [](v7) -- (v6) -- (v10);
%        
%    \path (v2) -- (v5) node [ font=\Huge, midway, sloped] {$\dots$};
