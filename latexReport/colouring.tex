...
We can translate the problem of map colouring to a problem about graphs. We do this by placing a vertex in each country and join two vertices with an edge if the corresponding countries share a border. 
\begin{figure}[h]
    \centering
