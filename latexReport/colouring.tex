...
\begin{proof}
    It suffices to show that there exists a graph in $\mathcal{P}$ for which bob has a winning strategy with $m=2w+\left\lceil\frac{p-1}{2}\right\rceil-1$ colours. Let the available colours be $C=\{c_1,c_2,\dots,c_m\}$.
