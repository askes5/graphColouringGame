...
Faigle, Kern, Kierstead, and Trotter 1993 \cite{faKeKiTr1993} introduced a winning strategy for Alice on the class of forests with four colours. We present the strategy here to give some inspiration for the activation strategy. This example misses some nuance of the full activation strategy. However, by the basic premise is the same.  
