...
The graph rank is technical detail used to prove results using the activation strategy. When using the activating strategy we get the following upper bound for the game colouring number. 
